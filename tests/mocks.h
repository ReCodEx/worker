...
public:
	...
	MOCK_METHOD1(job_archive_downloaded, void(const std::string &));
	MOCK_METHOD1(job_build_failed, void(const std::string &));
	MOCK_METHOD1(job_finished, void(const std::string &));
